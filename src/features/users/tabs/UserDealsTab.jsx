...
export default function UserDealsTab({ employeeId, enabled }) {
  const r = useUserRecords(employeeId, "deals", enabled);
  return (
    <div className="py-2">
      <TabToolbar
        search={r.search}
      ...
      />
      <UserRecordList items={r.data} loading={r.loading} resource="deals" />
      <ViewMoreButton
        hasMore={r.hasMore}
