...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-md shadow-md px-3 py-2 text-sm min-w-[148px]">
...
export default function DealPipelineChart({ data, loading }) {
