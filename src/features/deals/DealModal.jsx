...
export default function DealModal({
  ...
  const stageColor =
    STAGE_COLORS[isView ? viewingDeal?.stage : formData.stage] || "";
                  ...
                  <div className="flex flex-col items-center justify-center gap-3 py-12 text-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">
                        Create a task to track work for this deal
                      </p>
                    </div>
                    {onAddTask && (
                      <button
      ...
      <form onSubmit={onSubmit} className="flex flex-col h-full min-h-0">
        <div className="flex-1 overflow-y-auto min-h-0 space-y-4 px-1">
          <h2 className="text-lg font-semibold text-gray-800">
            {isCreate ? "Add New Deal" : "Edit Deal"}
          </h2>
  ...
  const title = isCreate
    ...
    : isEdit
      ? "Edit Deal"
      : viewingDeal?.title || "Deal Details";
